...
async function submit() {
  ...
  if (registering.value && password.value.length < 6) { error.value = 'A jelszónak legalább 6 karakterből kell állnia.'; return }
